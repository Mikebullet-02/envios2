<template>
  <div class="w-screen sm:w-auto ">
    <header class="w-screen">
      ...
      <div
        class="bg-inherit py-5 px-6 sm:py-20 sm:px-16 lg:py-20 lg:px-48 text-start text-neutral-800"
      >
        <h1
        ...
        >
          AHORRA HASTA 60% EN <br />
          LOGÍSTICA PARA TU <br />
          EMPRESA
        </h1>
        <div class="mx-auto max-w-[900px] sm:ml-5">
          <ul
            class="flex flex-col space-y-2 py-5 sm:pt-10 pb-10 text-lg sm:text-3xl text-gray-800"
          >
            ...
            <li>
              Servicio ocurre, en más de 50 ciudades
              <p class="text-gray-500 inline">
                (Bajío, Norte y Centro del país)
              </p>
            </li>
          </ul>
        </div>
        
        <div class="mx-auto max-w-[600px] sm:pt-[-100px] lg:pt-10 sm:ml-20 sm:py-20 sm:px-20">
          <button
            class="bg-[#003368] sm:w-auto h-14 sm:h-28 hover:bg-blue-600 text-white text-xl sm:text-4xl font-extrabold py-2 px-14 sm:py-2 sm:px-28 rounded-full"
          >
            Tarifas preferenciales
          </button>
        </div>
        <div class="flex flex-auto mx-auto w-auto sm:w-80 h-auto mr-28 lg:mt-[-675px] opacity-0 sm:opacity-100 hidden sm:block">
      <img
